...
class HoldingEventResultDao {
    fun getHoldingEventResults(holdingEventIds: List<Long>): List<HoldingEventResult> {
        return selectForHoldingEventResult { 
    ...
    fun getAllDeckIds(): List<String> {
        return HoldingEventResultTable
    ...
    private fun selectForHoldingEventResult(where: org.jetbrains.exposed.sql.SqlExpressionBuilder.() -> org.jetbrains.exposed.sql.Op<Boolean>) =
